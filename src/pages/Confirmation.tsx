            ...
            <CardContent className="p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">
                  Confirmation Number: <span className="font-mono font-semibold text-primary">{appointmentDetails.confirmationNumber}</span>
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold border-b pb-2">Doctor Information</h3>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <p className="text-sm text-muted-foreground">{appointmentDetails.hospital}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <p className="text-sm text-muted-foreground">{appointmentDetails.email}</p>
                    </div>
                    <div className="flex items-center space-x-3">
          ...
          <Card className="mt-8 bg-blue-50 border-blue-200">
            <CardContent className="p-6">
              ...
              <ul className="space-y-2 text-blue-700 text-sm">
                ...
                <li>• A reminder will be sent to you 24 hours before your appointment</li>
